...
namespace Physics_Data_Debug
{
    public partial class Form4Wheels : Form
    {
        ...
        public string X1LimiterSelection { get; set; } = _4WheelsSettings.X1Selection;
        public string Y1LimiterSelection { get; set; } = _4WheelsSettings.Y1Selection;
        public string Z1LimiterSelection { get; set; } = _4WheelsSettings.Z1Selection;
        ...
        {
            if (LimiterIsAbsoluteValue(cBSelection) == true)
            {
                minValue = 0;
            }
        ...
        public void UpdateAllLimiters()
        {
            ...
            string fifth;
            string sixth;
            if(LimiterIsAbsoluteValue(X1LimiterComboBox) == true)
            {
            ...
            if (LimiterIsAbsoluteValue(Y1LimiterComboBox) == true)
            {
            ...
            if (LimiterIsAbsoluteValue(Z1LimiterComboBox) == true)
            {
        ...
        private bool LimiterIsAbsoluteValue(ComboBox cb)
        {
        ...
        private double[] UpdateLimiterMinMaxArray(ComboBox cBLimiter, TextBox tBMin, double defaultMin, TextBox tBMax, double defaultMax)
        {
            ...
            if (LimiterIsAbsoluteValue(cBLimiter) == true)
            {
                defaultMin = 0;
            }
        ...
        private bool AbsoluteValueCheck(ComboBox cb, TextBox tBMin, double defaultMin, TextBox tBMax, double defaultMax)
        {
            ...
            if (enableCustomLimiter == true)
            {
                ...
                return LimiterIsAbsoluteValue(cb);
            }
            else
            {
                return false;
