...
namespace Physics_Data_Debug
{
    public partial class FormGForceSettings : Form
    {
        public FormGForceSettings()
        {
            ...
            SchemeComboBox.DrawItem += SchemeComboBox_DrawItem;
        ...
        private void applyButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                GForceSettings.HistoryAmountPoints = (int)TextBoxBaseParsers.HistoryAmountPointsParser(HistoryAmountPointsMaskedTextBox, GForceSettings.DefaultHistoryAmountPoints, true);
            ...
            else
            {
                ...
                GForceSettings.Y1Min = (double)TextBoxBaseParsers.Parser(Y1MinMaskedTextBox, GForceSettings.Y1DefaultMin, true);
                GForceSettings.Y1Max = (double)TextBoxBaseParsers.Parser(Y1MaxMaskedTextBox, GForceSettings.Y1DefaultMax, true);
